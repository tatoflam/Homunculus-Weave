...
**Layer 3: Template（構造）**
出力形式と検証基準 - 結果の構造化と品質保証
- `七格剖象法鑑定理論.md` - *【必読！】*七格剖象法の理論的根拠
- `AssessmentTemplate.md` - 鑑定書の標準フォーマット

**Layer 4: Interpretation（創造）**
文脈依存の解釈と献策 - LLM（Claude）が実行時に動的生成
- 象意の統合的読解（複数の数霊の関係性から人物像を構築）
- 文脈に応じた献策（相談者の状況を踏まえた戦略的提案）
- 詩的表現での伝達（理論を感性に響く言葉へ変換）

*注：Layer 4は静的ファイルではなく、Layer 1-3のデータと理論を基に、
