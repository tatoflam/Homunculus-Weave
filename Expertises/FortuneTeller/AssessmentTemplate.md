...
> [!NOTE]
> **作成者向け注意：陰陽配列診断の方法論**
> 陰陽配列診断は、`七格剖象法鑑定理論.md`の
> *「陰陽判定」セクション*の内容を確認のうえ実施する。
> LLM内の知識体系と混線させてはならない。
> この注意書きセクションは最終出力には含めないこと。
...
>
> // 3. 人材4類型の度数計算
> 軍人度 = 火星のカウント + 冥王星のカウント  # 有事の裁定者
> 天才度 = 天王星のカウント + 海王星のカウント  # 有事の推進者
> 秀才度 = 太陽のカウント + 木星のカウント + 水星のカウント  # 平時の裁定者
> 凡人度 = 月のカウント + 金星のカウント + 土星のカウント  # 平時の推進者
> ```
> この注意書きセクションは最終出力には含めないこと。
