...
> [!NOTE]
> **作成者向け注意：星導分布図の作図**
> 七格から抽出された系数と秘数が象徴する星導が
> どの天体に該当するかをカウントし、
> カウント結果の数を★で表示する。
> 系数7個と秘数7個なので、***★の数は合計14個***となる。
> ここでは天体の重み付けは行わないことに留意。
> この注意書きセクションは最終出力には含めないこと。
...
|---------------|-----------|---------|------|
| 人格→天格 | [人格の十干]→[天格の十干] | [五気] | [例：同じ木で共鳴] |
| 人格→外格 | [人格の十干]→[外格の十干] | [五気] | [例：木が火を生じる] |
| 人格→地格 | [人格の十干]→[地格の十干] | [五気] | [例：木が土を剋す] |
...
> 七格の系数と秘数から抽出された14の星導が指し示す
> *天体のカウント*と***重み付け***によって行い、
> LLM内の知識体系とは混線させないこと。
>
> **人材4類型の計算（疑似コード）**
> ```
> // 1. 七格星導分析から天体をカウント
> for each 格 in [天格, 人格, 地格, 総格, 外格, 雲格, 底格]:
>   天体[格.系数に対応する星導] += 1
>   天体[格.秘数に対応する星導] += 1
>
> // 2. 人格と総格の天体を重み付け（2倍）
> for each 天体 in 天体リスト:
>   if (天体が人格の星導) or (天体が総格の星導):
>     天体のカウント *= 2
>
> // 3. 人材4類型の度数計算
> 軍人度 = 火星のカウント + 冥王星のカウント
> 天才度 = 天王星のカウント + 海王星のカウント
> 秀才度 = 太陽のカウント + 木星のカウント + 水星のカウント
> 凡人度 = 月のカウント + 金星のカウント + 土星のカウント
> ```
>
> [!TIPS]
> - 軍人＝有事の裁定者（火星、冥王星）
